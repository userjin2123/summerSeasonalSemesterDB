		...
		<table border="1">
					...
					<tr>	
						...
						<span class="fas fa-tv"></span>samsung QLED 150인치 tv<br>
                                          ...
                                          <span class="fas fa-bed"></span>대형 더블침대 1개<br>
                                         <span class="fa fa-bath"></span> 샤워<br>
                                          화장실<br>
                                                             
                             
                                      
                                         <span class="fas fa-hot-tub"></span> 커플 전용 핀란드식 객실 전용 사우나 <br></td>
                        <td><td><span class="fas fa-money-check"></span>980,000&#8361;<br>
